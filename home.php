...
if(Phession::has('user')) {
    $user = Phession::get('user');
} else {
  ...
  <header class="cabecalho _fixo fixed-top w-100">
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-5 py-2">
      ...
      <div class="d-flex gap-3">
          <a href="logout.php" style="text-decoration: none;"><li class="nav-item rounded" style="list-style: none;">Sair</li></a>
          <li class="nav-item rounded" style="list-style: none;">
              <i class="fas fa-user" style="color: #0d6efd;"></i> <?= $user['name']; ?>
          </li>
      </div>
      </div>
      </div>
